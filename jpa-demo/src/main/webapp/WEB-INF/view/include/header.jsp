...
<nav>
    <div class="nav-wrapper">
        ...
        <ul id="nav-mobile" class="right hide-on-med-and-down">
            ...
            <li><a class="dropdown-trigger" href="#!" data-target="dropdown-teacher">Teacher<i class="material-icons right">arrow_drop_down</i></a></li>
    ...
    <ul id="dropdown-teacher" class="dropdown-content">
        <li><a href="<spring:url value="/teacher"/>"><i class="material-icons">person</i>List</a></li>
        <li><a href="<spring:url value="/teacher/create"/>"><i class="material-icons">person_add</i>Add</a></li>
    </ul>
</nav>
