...
//        groupRepository.saveAll(groupList);
        ...
        // Init students
        studentService.save(new StudentDto("Вася", "Пупкин","pupkin","{noop}qwer","ROLE_USER",
                LocalDate.of(2001, 1, 1), 1));

        studentService.save(new StudentDto("Маша", "Ефросинина","efrosina","{noop}123","ROLE_USER",
                LocalDate.of(1986, 2, 12), 1));

        // Init teachers
        TeacherDto teacherDto = new TeacherDto(null, "Василий", "Петрович","petrovich","{noop}asdf","ROLE_TEACHER", List.of(1, 2));
